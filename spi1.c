...
int main(void)
{
   ...
   while(1)
   {
	   ...
	   HAL_SPI_Transmit(&hspi1, buff_out, 1, HAL_MAX_DELAY);
	   //HAL_SPI_Receive(&hspi1, buff_IN, 1, HAL_MAX_DELAY);
...
void SPI1_Init(void)
{
	...
	hspi1.Init.NSS = SPI_NSS_HARD_OUTPUT; //this line changes when transmitting or receiving data, OUTPUT OR INPUT, in each case
